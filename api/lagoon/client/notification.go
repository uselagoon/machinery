...
func (c *Client) UpdateNotificationEmail(
	...
	req, err := c.newRequest("_lgraphql/notifications/updateNotificationEmail.graphql",
...
func (c *Client) UpdateNotificationSlack(
	...
	req, err := c.newRequest("_lgraphql/notifications/updateNotificationSlack.graphql",
		map[string]interface{}{
			"name":  input.Name,
			"patch": input.Patch,
		})
...
func (c *Client) UpdateNotificationRocketChat(
	...
	req, err := c.newRequest("_lgraphql/notifications/updateNotificationRocketChat.graphql",
		map[string]interface{}{
			"name":  input.Name,
			"patch": input.Patch,
		})
...
func (c *Client) UpdateNotificationMicrosoftTeams(
	...
	req, err := c.newRequest("_lgraphql/notifications/updateNotificationMicrosoftTeams.graphql",
		map[string]interface{}{
			"name":  input.Name,
			"patch": input.Patch,
		})
...
func (c *Client) UpdateNotificationWebhook(
	...
	req, err := c.newRequest("_lgraphql/notifications/updateNotificationWebhook.graphql",
		map[string]interface{}{
			"name":  input.Name,
			"patch": input.Patch,
		})
