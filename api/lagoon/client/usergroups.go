...
// UsersByOrganization queries the Lagoon API for users by the given organization name
func (c *Client) UsersByOrganizationName(ctx context.Context, name string, users *[]schema.OrgUser) error {
	...
	if org.Name == "" {
		...
		// this is because organizationbyname will return null instead of an error
