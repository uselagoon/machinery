...
// _lgraphql/projects/addProjectToOrganization.graphql
...
var _bindata = map[string]func() (*asset, error){
	...
	"_lgraphql/projects/addProjectToOrganization.graphql":                  _lgraphqlProjectsAddprojecttoorganizationGraphql,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"_lgraphql": &bintree{nil, map[string]*bintree{
		...
		"projects": &bintree{nil, map[string]*bintree{
			...
			"addProjectToOrganization.graphql":   &bintree{_lgraphqlProjectsAddprojecttoorganizationGraphql, map[string]*bintree{}},
