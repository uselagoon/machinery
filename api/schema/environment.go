...
type Environment struct {
	...
	AdvancedTaskDefinitions  []AdvancedTaskDefinition  `json:"advancedTasks,omitempty"`
	APIRoutes                []Route                   `json:"apiRoutes,omitempty"`
	AutogeneratedRouteConfig *AutogeneratedRouteConfig `json:"autogeneratedRouteConfig,omitempty"`
